...
const Header = () => {
  ...
  return (
    <header className="h-20 relative">
      <nav
        className={`fixed w-full z-50 top-0 transition-all duration-300 ${scrolled ? "bg-white/90 backdrop-blur-md shadow-lg" : "bg-white/80 backdrop-blur-md"
          }`}
      >
        ...
        {/* Mobile Menu */}
        <div
          className={`md:hidden fixed top-20 right-0 w-full bg-white/100 backdrop-blur-md shadow-lg transform transition-transform duration-300 ease-in-out ${isOpen ? "translate-x-0" : "translate-x-full"
            }`}
        >
