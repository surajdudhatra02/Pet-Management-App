      ...
      <div className="container mx-auto max-w-7xl px-4">
        <div className="text-center mb-16">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-lg md:text-xl text-gray-600 leading-relaxed mb-12">
              Founded in January 2022, we are a team of certified dog trainers
              mentored by Vaidya Sir—an esteemed Ex-Indian Army officer and
              Ex-Black Cat Commando. Our mission is to strengthen the bond
              between dogs and their owners through professional training and
              compassionate care.
            </p>
          </div>
        ...
        <div className="mt-16 text-center">
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Whether it's obedience training, behavioral correction, or
            protection training, we ensure that every dog receives personalized
            attention and expert guidance. Join us in building a stronger bond
